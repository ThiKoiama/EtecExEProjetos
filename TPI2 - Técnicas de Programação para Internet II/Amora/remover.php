...
<form name=RemoverProduto method=post action=admin_acoes.php>
ID do produto: <input type=text name=id_produto maxlength=50>
<br> Voce vai remover este produto do seu sistema por completo!! <br>
<input type=submit class="btn btn-light btn-sm pull-right"name=acao value=Remover>
